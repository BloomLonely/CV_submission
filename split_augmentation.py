...
def offline_augmentation(images_dir, labels_dir):
    image_files = [f for f in os.listdir(images_dir) if f.endswith('.jpg')]
    ...
    for img_file in image_files:
        ...
        cv2.imwrite(aug_img_path, flipped_img)
...
def augment_train_images(dataset_root, iter_num):
    ...
    if iter_num == 1:
        ...
        offline_augmentation(images_dir, labels_dir)

    split_dataset(dataset_root, 'CV_Competition', iter_num)
